...
*/ !(function() {
    ...
    function(e, t, n) {
      ...
      var h = function(e) {
          for (var t = [], n = y(e), r = v(e), i = n; i < r; i++)
                      ...
                      var h,
                        ...
                        h.fade &&
                          ...
                          h.vertical
                            ...
                            : (y.left = -h.index * parseInt(h.slideWidth)),
                          (y.opacity = h.currentSlide === h.index ? 1 : 0),
                          (y.transition =
                            "opacity " +
                            h.speed +
                            "ms " +
      ...
      var ge = (function(e) {
          function t(e) {
            ...
            return (
              ...
              be(ye(n), "trackRefHandler", function(e) {
                return (n.track = e);
              }),
              be(ye(n), "adaptHeight", function() {
              ...
              be(ye(n), "componentWillMount", function() {
                if (
                  (n.ssrInit(),
              ...
              be(ye(n), "componentDidMount", function() {
              ...
              be(ye(n), "componentWillUnmount", function() {
              ...
              be(ye(n), "componentWillReceiveProps", function(e) {
                for (
                  var t = fe(
              ...
              be(ye(n), "componentDidUpdate", function() {
                if (
                  (n.checkImagesLoad(),
              ...
              be(ye(n), "onWindowResized", function(e) {
              ...
              be(ye(n), "updateState", function(e, t, r) {
                var o = (function(e) {
                  var t,
              ...
              be(ye(n), "onLoadImage", function(e, t) {
                e.onload ||
                  (n.props.lazyLoad
                    ? (e.onload = function() {
                        n.adaptHeight(),
              ...
              be(ye(n), "checkImagesLoad", function() {
                var e = document.querySelectorAll(".slick-slide img");
                e.length,
                  Array.prototype.forEach.call(e, function(e) {
                    (e.onclick = n.onClickImage.bind(e)),
                      (e.onload = n.onLoadImage.bind(e));
                  });
              }),
              be(ye(n), "progressiveLazyLoad", function() {
                for (
                  var e = [],
              ...
              be(ye(n), "slideHandler", function(e) {
                var t =
                    1 < arguments.length &&
                    void 0 !== arguments[1] &&
                    arguments[1],
                ...
                if (d) {
                  ...
                  var y = d.lazyLoadedList.filter(function(e) {
              ...
              be(ye(n), "changeSlide", function(e) {
                var t =
                    1 < arguments.length &&
                    void 0 !== arguments[1] &&
                    arguments[1],
              ...
              be(ye(n), "clickHandler", function(e) {
                !1 === n.clickable && (e.stopPropagation(), e.preventDefault()),
                  (n.clickable = !0);
              }),
              be(ye(n), "keyHandler", function(e) {
                var t,
                  r,
                  i,
                  o = ((t = e),
              ...
              be(ye(n), "selectHandler", function(e) {
                n.changeSlide(e);
              }),
              be(ye(n), "disableBodyScroll", function() {
                window.ontouchmove = function(e) {
                  (e = e || window.event).preventDefault && e.preventDefault(),
                    (e.returnValue = !1);
                };
              }),
              be(ye(n), "enableBodyScroll", function() {
                window.ontouchmove = null;
              }),
              be(ye(n), "swipeStart", function(e) {
              ...
              be(ye(n), "onDotsOver", function() {
                return n.props.autoplay && n.pause("hovered");
              }),
              be(ye(n), "onDotsLeave", function() {
                return (
                  n.props.autoplay &&
              ...
              be(ye(n), "onTrackOver", function() {
                return n.props.autoplay && n.pause("hovered");
              }),
              be(ye(n), "onTrackLeave", function() {
                return (
                  n.props.autoplay &&
                  "hovered" === n.state.autoplaying &&
                  n.autoPlay("leave")
              ...
              be(ye(n), "onSlideFocus", function() {
                return n.props.autoplay && n.pause("focused");
              }),
              be(ye(n), "onSlideBlur", function() {
                return (
                  n.props.autoplay &&
